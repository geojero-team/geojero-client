...
export default {
  ...
  // 9경 배지 글자(코스 카드 배지, 2026-09-17 코스재설계 §5-2). ◎ 도장은 2026-09-17 밤 뺐다 — 글자만.
  ...
  // 9경 축은 nineScenic.stamp(글자만 — ◎ 도장은 2026-09-17 밤 뺐다)이고, 분류 축은 분류 칩 라벨(theme.*) 그대로라 여기 키가 없습니다. 9경이 0곳이면 배지 자체가 없습니다.
