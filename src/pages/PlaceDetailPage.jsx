...
import { PinIcon } from '../components/SpotDetail'
import { t } from '../i18n'
  ...
  return (
    <Screen data-api="GET /api/places/{placeId}">
      <div className={styles.scroll}>
        {state.status === 'ready' ? (
          <PlaceBody place={state.place} onBack={goBack} />
        ) : (
          <>
...
function PlaceBody({ place, onBack }) {
  ...
  return (
    <>
      <Photos images={images} onBack={onBack} />
