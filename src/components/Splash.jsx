...
/**
 * 시작화면 — 앱을 열면 2.3초 동안 보이고 홈으로 넘어갑니다(2026-09-19 사용자 · 09-20 2초 → 2.3초 — lib/useSplash).
 *
 * 움직임은 넣지 않습니다. 사용자가 모션 시안을 보고 정지로 결정했습니다.
 *
 * 앱 **위를 덮는 층**입니다(App.jsx). 홈을 대신 그리는 게 아니라 위에 얹는 이유는,
 * 그 2.3초 동안 아래에서 홈이 이미 뜨고 있어야 넘어간 순간 지도가 준비돼 있기 때문입니다.
 *
    ...
    <div className={styles.overlay}>
      ...
      <Screen>
        <div className={styles.root}>
          ...
          <div className={styles.box} style={{ backgroundImage: `url(${SPLASH_BLUR})` }}>
