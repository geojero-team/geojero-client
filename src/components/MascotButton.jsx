 ...
 *
 * 움직임 줄이기 설정이면 둥실 · 흔들기 없이 말풍선만 뜹니다.
 * 화면 읽기 프로그램에는 캐릭터 버튼을 「몽꾸」(말풍선을 펼치는 버튼 — aria-expanded), 말풍선을 그 글 그대로(시트를 여는 버튼)로 줍니다.
 */
  ...
  return (
    <div className={styles.wrap}>
      ...
      <button
        ...
        onClick={() => setRaised((on) => !on)}
        aria-label={t('mascot.name')}
        aria-expanded={raised}
        aria-controls={raised ? bubbleId : undefined}
      >
        {/* 팔이 몸 뒤라 팔을 먼저 그립니다. */}
